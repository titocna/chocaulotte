 ...
 */
function wonderplugin_3dcarousel_wp_trim_words( $text, $num_words = 55, $more = null ) {
	if ( null === $more ) {
		$more = __( '&hellip;' );
	}
...
function wonderplugin_3dcarousel_tags_allow( $allowedposttags ) {
	...
	$allowedposttags = apply_filters( 'wonderplugin_3dcarousel_custom_tags_allow', $allowedposttags );
	
	return $allowedposttags;
}

function wonderplugin_3dcarousel_css_allow($allowed_attr) {
	...
	$allowed_attr = apply_filters( 'wonderplugin_3dcarousel_custom_css_allow', $allowed_attr );
	
	return $allowed_attr;
}

function wonderplugin_3dcarousel_wp_check_filetype_and_ext($data, $file, $filename, $mimes) {
