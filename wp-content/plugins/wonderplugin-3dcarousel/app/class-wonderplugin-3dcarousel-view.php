...
class WonderPlugin_3DCarousel_View {
	...
	function print_edit_settings() {
		...
		<tr>
			...
			<td><label><input name='jetpackdisablelazyload' type='checkbox' id='jetpackdisablelazyload' <?php echo ($jetpackdisablelazyload == 1) ? 'checked' : ''; ?> /> Disable Jetpack lazy load for 3d carousel thumbnail images</label>
			</td>
		</tr>
	...
	?>
		...
		<ul class="wonderplugin-tabs-horizontal" id="wonderplugin-popup-display-panels">
        	...
        	<p><label><input type="radio" name="keepid" value=0>Append to the existing 3d carousel list </label></p>
